<template>
  <div class="container">
    <a href=" " @click.default="_PAUSED=!_PAUSED">
    ...
    <div v-else>🩲</div>
    <p>region:{{region}}</p>
    <div v-for="_region in _REGIONS" :class="_region.handle==region? 'font-black': ''"><a href="" @click.default="region=_region.handle">{{_region.handle}}</a></div>
    <hr/>
    <!-- <a @click.default="_REGIONAUDIT() " class="underline " href=" ">regnaudit</a> 🦋 -->
    ...
    <!-- <a @click.default="_FAKETRACE " class="underline " href=" ">faketrxc</a> -->
    <a @click.default="_FAKETRACE" class="underline " href="">faketrxc</a>
    <ol>
...
const PROPS = defineProps({ region: String, card: String, basemap: String, center: String, zoom: String }),
  ROUTE = useRoute(),
  ROUTER = useRouter(),
  _LOADING = ref(false),
  ...
  // ,_TRACEARKIVEGEOM = ref({ // "type ": "FeatureCollection ", // "features ": [{ // "type ": "Feature ", // "properties ": {}, // "geometry ": { // "type ": "LineString ", // "coordinates ": [ // [-71.14183902740479, // 42.33044080887696 // ], // [-71.13952159881592, // 42.33354989703499 // ] // ] // } // }]
// })
